...
const Sidebar = ({ className }) => {
  return (
    ...
    >
      <h3 className="text-md font-medium text-primary-light px-5 py-3">Main</h3>
      <ListItem
        icon={
          <svg
      ...
      <h3 className="text-md font-medium text-primary-light px-5 py-3">
        Administration
      </h3>
      ...
      <ListItem
        ...
        navigate={"/results"}
      />
      <h3 className="text-md font-medium text-primary-light px-5 py-3">Settings</h3>
      <ListItem
        icon={<SendIcon />}
        listTitle={"Admin"}
